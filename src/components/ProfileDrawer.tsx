...
const CONTRIBUTOR_TIERS: Array<{ min: number; slug: string; emoji: string; color: string }> = [
  ...
  { min: 3,    slug: 'pumbahaldjas',      emoji: '🧚', color: '#94a3b8' },
  { min: 5,    slug: 'hinnakirjutaja',    emoji: '📝', color: '#3b82f6' },
  { min: 8,    slug: 'kutusekratt',       emoji: '✨', color: '#3b82f6' },
  { min: 12,   slug: 'tanklaspioon',      emoji: '🕵️', color: '#3b82f6' },
  { min: 17,   slug: 'bensiinihunt',      emoji: '🐺', color: '#3b82f6' },
  { min: 23,   slug: 'hinnakutt',         emoji: '🏹', color: '#8b5cf6' },
  ...
  { min: 360,  slug: 'pumbatark',         emoji: '🧙', color: '#f59e0b' },
